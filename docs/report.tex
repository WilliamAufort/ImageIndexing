...
\begin{itemize}
 ...
 \item with the class \textt{glass}, we get also surprising results (no good retrieval with score $< 10$). Contrary to the previous case, we can't provide any satisfying explanation to it.
\end{itemize}
